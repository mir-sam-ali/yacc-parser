...
static const yytype_uint8 yyprhs[] =
{
      ...
      25,    27,    30,    32,    34,    37,    41
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      16,     0,    -1,    17,     8,    -1,    16,    17,     8,    -1,
      18,    19,    -1,    13,    -1,    12,    -1,    14,    -1,    20,
      -1,    19,     9,    20,    -1,    21,    -1,    21,    22,    -1,
       4,    -1,    23,    -1,    22,    23,    -1,    10,    24,    11,
      -1,     3,    -1
};
...
{
     -11,   -12,   -12,   -12,     0,    -4,     1,   -12,    -2,   -12,
     -12,    -1,   -12,    -3,   -12,     1,     6,    -3,   -12,   -12,
     -12,     4,   -12,   -12
};
...
{
       7,     1,     2,     3,     9,    10,    14,    16,    15,    20,
      19,     8,     1,     2,     3,    23,     0,     0,     0,    22
};

static const yytype_int8 yycheck[] =
{
       0,    12,    13,    14,     8,     4,     8,    10,     9,     3,
      15,     4,    12,    13,    14,    11,    -1,    -1,    -1,    17
};
...
{
       0,    12,    13,    14,    16,    17,    18,     0,    17,     8,
       4,    19,    20,    21,     8,     9,    10,    22,    23,    20,
       3,    24,    23,    11
};
...
#line 66 "parser.y"
    { (yyval.snode) = (struct Snode *) malloc(sizeof(struct Snode)); 
									...
									strcpy((yyval.snode)->type, "integer");
						 			(yyval.snode)->right = NULL; 
						 			(yyval.snode)->left = NULL; 
								}
    break;
...
#line 82 "parser.y"
    { (yyval.snode) = (struct Snode *) malloc(sizeof(struct Snode)); 
									...
									strcpy((yyval.snode)->type, "character");
						 			(yyval.snode)->right = NULL; 
						 			(yyval.snode)->left = NULL; 
								}
    break;
...
#line 145 "parser.y"
    { (yyval.snode) = (struct Snode *) malloc(sizeof(struct Snode)); 
			 						...
			 						strcpy((yyval.snode)->lexval, (yyvsp[(1) - (1)].snode)->lexval);
									(yyval.snode)->size=(yyvsp[(1) - (1)].snode)->size;
						 			(yyval.snode)->right = NULL; 
						 			(yyval.snode)->left = (yyvsp[(1) - (1)].snode); 
								}
    break;
...
#line 153 "parser.y"
    { (yyval.snode) = (struct Snode *) malloc(sizeof(struct Snode)); 
			 						strcpy((yyval.snode)->tok, "");									
			 						strcpy((yyval.snode)->lexval, strcat((yyvsp[(1) - (2)].snode)->lexval,(yyvsp[(2) - (2)].snode)->lexval));
									(yyval.snode)->size=(yyvsp[(1) - (2)].snode)->size*(yyvsp[(2) - (2)].snode)->size;
						 			(yyval.snode)->right = (yyvsp[(2) - (2)].snode); 
						 			(yyval.snode)->left = (yyvsp[(1) - (2)].snode); 
								}
    break;
...
#line 160 "parser.y"
    { (yyval.snode) = (struct Snode *) malloc(sizeof(struct Snode)); 
			 						strcpy((yyval.snode)->tok, "");									
									char dest[20]="[";
									strcat(dest,strcat((yyvsp[(2) - (3)].snode)->lexval,"]"));
			 						strcpy((yyval.snode)->lexval,dest);
									(yyval.snode)->size=(yyvsp[(2) - (3)].snode)->size;
						 			(yyval.snode)->right = (yyvsp[(2) - (3)].snode); 
						 			(yyval.snode)->left = NULL; 
								}
    break;
...
#line 169 "parser.y"
    { (yyval.snode) = (struct Snode *) malloc(sizeof(struct Snode)); 
			 						...
			 						strcpy((yyval.snode)->lexval, (yyvsp[(1) - (1)].lexeme));
									(yyval.snode)->size=atoi((yyvsp[(1) - (1)].lexeme));
						 			(yyval.snode)->right = NULL; 
						 			(yyval.snode)->left = NULL; 
								}
    break;
